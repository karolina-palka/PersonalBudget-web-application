...
if (!isset($_POST['amount'])) {
	header('Location: addFinance.php');
	exit();
} else {
	
	if (isset($_POST['finance_date'])) {
				...
				<div  id="custom-container" class="col-12 col-md-8">
					<?php
							if (isset($_SESSION['done'])) {
								...
								echo '<div class="communication">'.$_SESSION['done'].'<p><a class="dark-link" href="addFinance.php">Add another income >></a></p></div>';
								unset ($_SESSION['done']);
								
							} else {
								echo '<div class="text-center label-margin ">'."Something has gone wrong".'</div>';
								echo '<p><a class="dark-link" href="addFinance.php">Add another income >></a></p>';
							}
